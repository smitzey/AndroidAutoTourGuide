...
public class MyAlarmBroadcastReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_READ = "info.androidautobook.helloauto.ACTION_READ" ;
    private static  final String REPLY_ACTION =  "info.androidautobook.helloauto.REPLY_ACTION" ;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //String messageContent = "HelloAuto " + System.currentTimeMillis()  ;
        String messageContent = "Hello Auto"  ;
